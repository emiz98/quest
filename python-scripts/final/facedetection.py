...
import sys
import imutils
from utility import rotate_head


def head_function(stop_event):
    ...
    while not stop_event.is_set():
        ...
        faces = face_cascade.detectMultiScale(gray, scaleFactor=2.5, minNeighbors=1)
        ...
        cv2.line(
            frame, (left_boundary, 0), (left_boundary, frame.shape[0]), (255, 0, 0), 2
        )
        cv2.line(
            frame, (right_boundary, 0), (right_boundary, frame.shape[0]), (255, 0, 0), 2
        )
        ...
        for x, y, w, h in faces:
            ...
            if frame_count % 12 == 0:
                if global_x_coordinate_arr[-1] != global_x_coordinate_arr[-2]:
                    rotate_head(global_x_coordinate)
